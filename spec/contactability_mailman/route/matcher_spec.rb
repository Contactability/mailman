...
describe ContactabilityMailman::Route::Matcher do

  before do
    @matcher = ContactabilityMailman::Route::Matcher.new('test')
  end

  it 'should have base methods to override' do
    lambda { @matcher.match('test') }.should raise_error(NotImplementedError)
    lambda { ContactabilityMailman::Route::Matcher.valid_pattern?('test') }.should raise_error(NotImplementedError)
  ...
  describe 'singleton' do
    ...
    it 'should have an array of registered matchers' do
      ContactabilityMailman::Route::Matcher.matchers.should include(TestMatcher)
    end

    it 'should be able to find and create a matcher instance' do
      matcher_class = ContactabilityMailman::Route::Matcher
...
class TestMatcher < ContactabilityMailman::Route::Matcher
