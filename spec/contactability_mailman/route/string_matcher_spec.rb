...
describe ContactabilityMailman::Route::StringMatcher do

  it 'should be registered with Matcher' do
    ContactabilityMailman::Route::Matcher.create('test').class.should == ContactabilityMailman::Route::StringMatcher
  end
